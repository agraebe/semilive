...
import Semilive from '../lib/semilive';
...
describe('Semilive', () => {
  ...
  beforeEach(() => {
    ...
    activationPromise = atom.packages.activatePackage('semilive');
  });

  describe('when the semilive:toggle event is triggered', () => {
    it('hides and shows the modal panel', () => {
      // Before the activation event the view is not on the DOM, and no panel
      // has been created
      expect(workspaceElement.querySelector('.semilive')).not.toExist();
